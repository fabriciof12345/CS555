...
class MyTestCase(unittest.TestCase):
    ...
    INDI_F = {
        '@I1@': ['Javier /Diaz/', 'M', '16 SEP 1998', 20, True, 'N/A', ['@F1@', 'N/A']],
        '@I2@': ['Miguel /Diaz/', 'M', '9 SEP 1967', 53, True, 'N/A', ['N/A', '@F1@'], ['N/A', '@F2@'],
                 ['@F3@', 'N/A']],
        '@I3@': ['Deysi /Geronimo/', 'F', '3 JAN 1979', 41, True, 'N/A', ['N/A', '@F1@'], ['@F4@', 'N/A']],
        '@I4@': ['Xavier /Diaz/', 'M', '27 AUG 2000', 20, True, 'N/A', ['@F1@', 'N/A']],
    ...
    def test_no_birth_on_marr_T(self):
        self.assertTrue(US48.childbirthsOnMarriage(FAM, INDI))

    def test_no_birth_on_marr_F(self):
        self.assertFalse(US48.childbirthsOnMarriage(FAM, INDI_F))
